...
function AltaRanged:setDefaults()
  ...
  self.actionPresets = {
    ...
    nade = { method=self.blast, type='ct_impulse_nade', count=1, params={ }, inaccuracy=0.0, interval=0.0, flash=false, },
    projectile = { method=self.blast, type='rocketshell', count=1, params={ }, inaccuracy=0.12, interval=0.0, },
    explosion = { method=self.blast, type='ct_impulse_nade', count=1, params={ timeToLive=0.0, speed=0, }, inaccuracy=0.0, interval=0.0, },
