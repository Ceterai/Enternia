...
function init()
  ...
  self.weapon:addAbility(getAbil(AltaRifleSwitch, "alt"))
...
function AltaRifle:setParams()
  ...
  self.pressType = params.pressType or 'none'
  self.pressParams = params.pressParams or { }
  ...
  self.holdType = params.holdType or 'none'
  self.holdParams = params.holdParams or { }
...
function AltaRifle:setDefaults()
  ...
  self.fireTypes = self.fireTypes or {
    charge = {
      pressType = 'blast',
      pressParams = { type = 'ct_impulse_medium', sound = 'primary_press', },
      holdType = 'blast',
      holdParams = { type = 'ct_impulse_large', sound = 'primary_hold', },
      holdStart = 'charge',
      holdLoop = 'charging',
    },
    semi = {
      pressType = 'semi',
      pressParams = { type = 'ct_impulse_medium', count = 2, },
      holdTimeMax = 0,
    },
  }
  self:setParams()
